...
A web application that visualizes AI model battle conversations from CSV data, mimicking the LM Arena interface.
...
- Clean, chat-like interface similar to LM Arena
